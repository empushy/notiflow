        ...
        <main className="grow">
          ...
          <div className="sm:flex sm:justify-between sm:items-center px-4 sm:px-6 py-8 border-b border-white/60">
            ...
            <div className="mb-4 sm:mb-0">
              <h1 className="text-2xl md:text-3xl text-slate-900 font-bold">Empty State</h1>
            </div>
          ...
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            <div className="max-w-2xl m-auto mt-16">
              <div className="text-center px-4">
                ...
                <h2 className="text-2xl text-slate-900 font-bold mb-2">Pay your bills in just a few clicks</h2>
                <div className="mb-6">
