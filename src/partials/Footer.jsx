function Footer() {
  return (
    <footer className="nf-panel-strong border-t border-pink-100/80">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-slate-900 mb-4">NotiFlow</h3>
            ...
            <div className="flex space-x-4">
              <a
                href="https://twitter.com/empathetic_push"
                target="_blank"
          ...
          <div>
            <h4 className="text-sm font-semibold text-slate-900 tracking-wider uppercase mb-4">Product</h4>
            <ul className="space-y-2">
              <li>
                <a href="/pricing" className="text-slate-600 hover:text-pink-500">
                  Pricing
                </a>
              </li>
              <li>
          ...
          <div>
            <h4 className="text-sm font-semibold text-slate-900 tracking-wider uppercase mb-4">Quick Links</h4>
            <ul className="space-y-2">
              <li>
                <a href="/about" className="text-slate-600 hover:text-pink-500">
                  About
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/newsletter" className="text-slate-600 hover:text-pink-500">
                  Newsletter
                </a>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-pink-100">
          <p className="text-center text-slate-500 text-sm">© 2026 NotiFlow. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
