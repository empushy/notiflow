...
const NotificationStatCard = ({ stat, initialQuantity, autoIncrease }) => {
  ...
  return (
    <motion.div className="flex flex-col h-full col-span-12 sm:col-span-6 lg:col-span-4 bg-card border border-border rounded-xl shadow-sm hover:shadow-md transition-all duration-300">
      <div className="px-6 pt-6 pb-5">
        <h2 className="text-xs sm:text-sm font-medium uppercase tracking-wide mb-2">
          {stat}
        </h2>
        <motion.p className="text-2xl sm:text-3xl lg:text-4xl font-bold">
          {displayNumber}
        </motion.p>
